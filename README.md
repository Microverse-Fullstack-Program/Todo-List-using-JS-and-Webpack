...
> This awesome books page built using plain JavaScript with ES6. The aim of this project is to master javascript object and DOM manipulation and ES6. 
...
4. Clone the repo using the below command
 > git clone  https://github.com/Microverse-Fullstack-Program/Awesome-Books-With-ES6.git
...
Feel free to check the [issues page](https://github.com/Microverse-Fullstack-Program/Awesome-Books-With-ES6/issues).
